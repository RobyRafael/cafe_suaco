<?php 
include('koneksi.php');
$ambilsemuadatabarangkeluar = mysqli_query($koneksi, "SELECT `data_barang`.`nama_barang`, 
                    `barang_keluar`.`jumlah`, `jenis_barang`.`jenis_barang`,
                    barang_keluar.tanggal_keluar FROM barang_keluar 
    ...
    <section class="content">
      ...
      <form class="form-horizontal" method="post" action="konfirmasieditbarangmasuk.php" enctype="multipart/form-data">
        <div class="card-body">          
          ...
          <div class="form-group row">
            <label for="tanggal_keluar" class="col-sm-3 col-form-label">Waktu Transaksi</label>
            <div class="col-sm-7">
              <input type="text" class="form-control" name="tanggal_keluar" id="tanggal_keluar" value="<?php echo $tanggal_keluar;?>">
            </div>
          </div>
        </div>
                <!-- /.card-body -->
