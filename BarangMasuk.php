    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="./Datastaff.php" class="nav-link">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php
                    $ambilsemuadatabarangmasuk = mysqli_query($koneksi, "SELECT `id_barang_masuk`, `barang_masuk`.`nama_barang`, 
                 ...
                 <?php if ($_SESSION['level']=="user"){?>
                  <a class="btn btn-primary btn-sm" href="Edit_barangmasuk.php?data=<?php echo $id_barang_masuk;?>"><i class="fas fa-edit"></i> Edit</a>
                  <a class="btn btn-danger btn-sm" data-toggle="modal" data-target="#modal-HapusData"><i class="fas fa-trash"></i> Hapus</a>
                <?php }?>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
              ...
              <form class="form-horizontal">
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="number" class="form-control" id="inputJumlah" placeholder="Jumlah Barang">
                    </div>
                  </div>
                  <div class="form-group row">
                  ...
                  <div class="form-group row">
                    <label for="inputWTransaksi" class="col-sm-2 col-form-label">Transaksi</label>
                    <div class="col-sm-10">
                      <input type="date" class="form-control" id="inputWTransaksi" placeholder="Waktu Transaksi">
                    </div>
                  </div>
                  <!--<div class="form-group row">
            ...
            <div class="modal-footer justify-content-between">
              <button type="button" href="tambahbarangmasuk.php" class="btn btn-default" data-dismiss="modal">Batal</button>
      ...
      <div class="modal fade" id="modal-EditData">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" action="tambahbarangmasuk.php" method = "post">
                <div class="card-body">
                  <div class="form-group row">
                    <label for="EditNBarang" class="col-sm-2 col-form-label">Barang</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="nama_barang" id="EditNBarang" placeholder="Nama Barang">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="EditJumlah" class="col-sm-2 col-form-label">Jumlah</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="jumlah" id="EditJumlah" placeholder="Jumlah Barang">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="EditKategori" class="col-sm-2 col-form-label">Kategori</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="jenis_barang" id="EditKategori" placeholder="Kategori Barang">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="EditSupplier" class="col-sm-2 col-form-label">Supplier</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="supplier"  id="EditSupplier" placeholder="Nama Supplier">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="EditWTransaksi" class="col-sm-2 col-form-label">Transaksi</label>
                    <div class="col-sm-10">
                      <input type="date" class="form-control" name="tanggal_masuk" id="EditWTransaksi" placeholder="Waktu Transaksi">
                    </div>
                  </div>
                  <!--<div class="form-group row">
                    <div class="offset-sm-2 col-sm-10">
        ...
        <div class="modal-dialog">
          <div class="modal-content bg-danger">
            ...
            <div class="modal-footer justify-content-between">
              ...
              <button type="button" href="hapus_barangmasuk.php?php echo $id_barang_masuk;?" class="btn btn-outline-light">Ya</button>
            </div>
          </div>
          <!-- /.modal-content -->
        </div>
