...
<head>
  ...
  <title>Cafe Suaco | Data User</title>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                  <?php
                  $ambilsemuadatauser = mysqli_query($koneksi, "select `id_user`,`nama`,`email`,`username`,`password`,`level` from user where `id_user`");
                  $no = 1;
                  ...
                  <tr>
                    ...
                    <td><?=$level;?></td>
                      ...
                      <td>
                      <a class="btn btn-primary btn-sm" href="Edit_datauser.php?data=<?php echo $id_user;?>"><i class="fas fa-edit"></i> Edit</a>
              ...
              <form class="form-horizontal">
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="password" placeholder="Kata Sandi">
                    </div>
                  </div>
                    <div class="form-group row">
                  ...
                  <div class="form-group mb-0">
                    <div class="custom-control custom-checkbox">
                      ...
                      <label class="custom-control-label" for="exampleCheck1">Saya setuju dengan <a href="#">syarat dan ketentuan</a>.</label>
                    </div>
                  </div>
                  </form>
                  <!--<div class="form-group row">
