...
<head>
  ...
  <title>Cafe Suaco | Barang Keluar</title>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="./BarangKeluar.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Barang Keluar</p>
                </a>
            </ul>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php
                     $ambilsemuadatabarangkeluar = mysqli_query($koneksi, "ELECT `data_barang`.`nama_barang`, 
                    `barang_keluar`.`jumlah`, `jenis_barang`.`jenis_barang`,
                    barang_keluar.tanggal_keluar FROM barang_keluar S
                    INNER JOIN data_barang ON barang_keluar.id_barang=data_barang.id_barang
                  ...
                  <tr>
                    ...
                    <?php if ($_SESSION['level']=="user"){?>
                      <a class="btn btn-primary btn-sm" href="Edit_barangkeluar.php"><i class="fas fa-edit"></i> Edit</a>
              ...
              <form class="form-horizontal">
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="date" class="form-control" id="EditWTransaksi" placeholder="Waktu Transaksi">
                    </div>
                  </div>
                  <!--<div class="form-group row">
                    <div class="offset-sm-2 col-sm-10">
