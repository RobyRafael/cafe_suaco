            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php
                  $ambilsemuadatabarang = mysqli_query($koneksi, "SELECT `id_barang`, `data_barang`.`nama_barang`, `jenis_barang`.`jenis_barang` FROM barang_masuk 
                  ...
                  <tr>
                    ...
                    <?php if ($_SESSION['level']=="user"){?>
                      <a class="btn btn-primary btn-sm" href="Edit_databarang.php?data=<?php echo $id_barang;?>"><i class="fas fa-edit"></i> Edit</a>
