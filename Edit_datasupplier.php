<?php 
include('koneksi.php');
$id_supplier = $_GET['data'];
$ambilsemuadatasupplier = mysqli_query($koneksi, "SELECT `id_supplier`,`nama_supplier`,`alamat`,`no_telepon` from data_supplier where id_supplier='$id_supplier'"); 
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="Rekap Barang.php" class="nav-link">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      if(isset($_GET['notif']) && $_GET['notif'] == "editkosong"){
        echo "<div class='notif'>Maaf, {$jenis} wajib diisi</div>";
        
      }
      ?>
      <form class="form-horizontal" method="post" action="konfirmasieditdatasupplier.php" enctype="multipart/form-data">
        <div class="card-body">          
              ...
              <form id="quickForm">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" name="supplier" class="form-control" id="supplier" value="<?php echo $nama_supplier;?>">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="no_telepon" class="form-control" id="no_telepon" value="<?php echo $no_telepon;?>">
                  </div>
                </div>
                <!-- /.card-body -->
