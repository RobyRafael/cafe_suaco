<?php
// Sesuaikan path dan nama sesi dengan kebutuhan
session_start();
...
if ($_SERVER['REQUEST_METHOD'] == 'GET' && isset($_GET['id'])) {
    ...
    $query = "SELECT * FROM barang_masuk WHERE id_barang = $id_barang";
    $result = mysqli_query($koneksi, $query);

    if ($result) {
        $data = mysqli_fetch_assoc($result);

        // Sesuaikan dengan struktur data dan field di tabel
...
include('header.php'); // Sertakan file header.php atau sesuaikan dengan kebutuhan
?>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Edit Data Stok</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <!-- Tambahkan formulir edit di dalam konten -->
<div class="content-wrapper">
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-primary">
                        ...
                        <form method="post" action="konfirmasieditdatastok.php">
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="editNBarang">Nama Barang</label>
                                    <input type="text" name="nama_barang" class="form-control" id="editNBarang" value="<?=$nama_barang;?>" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="editStok">Stok</label>
                                    <input type="number" name="jumlah" class="form-control" id="editStok" value="<?=$jumlah;?>" required>
                                </div>
                                <div class="form-group">
                                    <label for="editKategori">Kategori</label>
                                    <input type="text" name="jenis_barang" class="form-control" id="editKategori" value="<?=$jenis_barang;?>" readonly>
                                </div>
                                <input type="hidden" name="id_barang" value="<?=$id_barang;?>">
                            </div>
                            <div class="card-footer">
                                <button type="submit" class="btn btn-primary">Simpan</button>
                                <a href="DataStok.php" class="btn btn-secondary">Batal</a>
                            </div>
                        </form>
                    </div>
                </div>
...
<?php include('footer.php'); // Sertakan file footer.php atau sesuaikan dengan kebutuhan ?>
