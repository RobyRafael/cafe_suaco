...
include('koneksi.php');
    ...
    $id = $_GET['data'];
    $ambilsemuadatabarang = mysqli_query($koneksi, "select `nama_barang`,`jenis_barang FROM `data_barang` WHERE `id` = '$id'");
    WHERE `id` = '$id'");
    while($data = mysqli_fetch_array($ambildatabarangmasuk)){
...
<head>
  ...
  <title>Cafe Suaco | Data Barang</title>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="./DataBarang.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Data Barang</p>
                </a>
              </li>
              ...
              <form id="quickForm">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" name="nama_barang" class="form-control" id="nama_barang" value="<?php echo $nama_barang;?>">
                  </div>
                  <div class="form-group">
                    <label for="jenis_barang">Kategori</label>
                    <input type="text" name="jenis_barang" class="form-control" id="jenis_barang" value="<?php echo $jenis_barang;?>">
                  </div>
                </div>
                <!-- /.card-body -->
